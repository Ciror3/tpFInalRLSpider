...
class SpiderEnv(gym.Env):
    ...
    def __init__(self, target_init_pos=None, map_shape=4, success_radius=0.15, max_steps=200,render_mode=None):
        ...
        self.commands = {
            ...
            # 1: (228), #Pivot Right
            1: (251,[0.0776,-0.0074,np.deg2rad(10.94)]), #FwdSteer Left
            2: (252,[0.0773,0.0,np.deg2rad(4.44)]), #Fwd
            3: (253,[0.0748,0.0064,np.deg2rad(9.79)]), #FwdSteer Right
            4: (256,[-0.0603,0.0025,np.deg2rad(5.81)]), #BwdSteer Left
            5: (258,[-0.0641,0.002,0.03175]), #BwdSteer Right
            # 7: 261, #FastFwdSteer Left
            6: (262,[0.0893,0.0,0.0]), #FastFwd
            # 9: 263, #FastFwdSteer Right
            7:(266,[-0.0588,0.0,0.0]), #Bwd
            8:(267,[-0.715, 0.0, 0.0]), #FastBwd
        }
